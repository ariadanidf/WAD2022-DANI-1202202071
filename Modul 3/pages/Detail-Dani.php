    ...
    <section>
        ...
        <div class="container justify-content-start">
            <div class="row">
                ...
                <div class="col">
                    <form action="./Edit-Dani.php?id=<?=$hasil['id_mobil']?>" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="idMobil" value="<?= $hasil["id_mobil"];?>">

                        <div class="mb-3">
                            <label for="namaMobil" class="form-label fw-bold">Nama Mobil</label>
                            <input type="text" class="form-control" id="namaMobil" name="namaMobil" value="<?=$hasil['nama_mobil'];?>" disabled>
                        </div>

                        <div class="mb-3">
                            <label for="namaPemilik" class="form-label fw-bold">Nama Pemilik</label>
                            <input type="text" class="form-control" id="namaPemilik" name="namaPemilik" value="<?=$hasil['pemilik_mobil'];?>" disabled>
                        </div>

                        <div class="mb-3">
                            <label for="merk" class="form-label fw-bold">Merk</label>
                            <input type="text" class="form-control" id="merk" name="merk" value="<?=$hasil['merk_mobil'];?>" disabled>
                        </div>

                        <div class="mb-3">
                            <label for="tglBeli" class="form-label fw-bold">Tanggal Beli</label>
                            <input type="date" class="form-control" id="tglBeli" name="tglBeli" value="<?=$hasil['tanggal_beli'];?>" disabled>
                        </div>

                        <div class="mb-3">
                            <label for="deskripsi" class="form-label fw-bold">Deskripsi</label>
                            <textarea rows="3" class="form-control" id="deskripsi" name="deskripsi" placeholder="<?=$hasil['deskripsi'];?>" disabled></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="foto" class="form-label fw-bold">Foto</label>
                            <input class="form-control" name="foto" type="file" id="foto" style="color: transparent" value="<?=$hasil["foto_mobil"]; ?>" disabled>
                        </div>
                        ...
                        <?php
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="statusPembayaran" id="statusPembayaran1" value="Lunas" disabled>
                                <label class="form-check-label" for="statusPembayaran">Lunas</label>
                            </div>
                            <div class="form-check form-check-inline">
